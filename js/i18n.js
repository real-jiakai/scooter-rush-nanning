...
const STRINGS = {
  zh: {
    ...
    'ui.on': '开',
    'ui.off': '关',
    'ui.invincibleDesc': '护盾无限 · 永不打滑 · 无敌局不计入最佳成绩',
    'ui.invincibleTag': '⚡ 无敌模式 · 成绩不计入最佳',
    'ui.passenger': '带上对象',
    'ui.passengerDesc': '后座多一人：得分 ×1.5 —— 但压到井盖 TA 会生气，怒气满了 TA 直接坐气球回家',
    'ui.partner': '对象状态',
    'ui.partnerStayed': '😊 全程陪伴',
    'ui.partnerLeft': '🎈 中途气回家了',
    'manhole.hit': '哐当！压到井盖 -8',
    'anger.left': '{who}气到坐气球回家了…',
    'anger.list': [
      '你不会绕一下吗？！',
      '井盖！又是井盖！',
      '我腰要断了！',
  ...
  en: {
    ...
    'ui.invincible': 'INVINCIBLE MODE',
    'ui.on': 'ON',
    'ui.off': 'OFF',
    'ui.invincibleDesc': 'Infinite shield · no spin-outs · runs don’t count toward your best',
    'ui.invincibleTag': '⚡ INVINCIBLE · not counted toward best',
    'ui.passenger': 'BRING YOUR SO',
    'ui.passengerDesc': 'Back-seat passenger: score ×1.5 — but manholes make them angry, and at max anger they balloon straight home',
    'ui.partner': 'PASSENGER',
    'ui.partnerStayed': '😊 stayed the whole ride',
    'ui.partnerLeft': '🎈 rage-ballooned home',
    'manhole.hit': 'CLUNK! Manhole cover -8',
    'anger.left': '{who} ballooned home in a huff…',
    'anger.list': [
      ...
      'How many times — AVOID the covers!',
      'One more and you ride alone!',
    ],
    'stat.speed': 'SPD',
    'stat.accel': 'ACC',
    'stat.handling': 'HDL',
